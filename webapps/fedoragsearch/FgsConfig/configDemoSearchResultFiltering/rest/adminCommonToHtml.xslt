			...
			<body>
				<div id="header">
					...
					<div align="right">
						...
						using <a href="FgsConfig/configDemoSearchResultFiltering" title="to see config files set tomcat/conf/web.xml listings to true">configDemoSearchResultFiltering</a></h4>
					</div>
				</div>
